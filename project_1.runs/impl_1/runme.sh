...
HD_PWD='C:/Users/Student/Documents/mef/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log proj.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source proj.tcl -notrace
