...
HD_PWD='C:/Users/Student/Documents/mef/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log proj.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source proj.tcl
